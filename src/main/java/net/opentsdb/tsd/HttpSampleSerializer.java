...
class HttpSampleSerializer extends HttpSerializer {
  private static final Logger LOG =
    LoggerFactory.getLogger(HttpSampleSerializer.class);
   ...
   */
  public HttpSampleSerializer(final HttpQuery query) {
    super(query);
  }
